...
public class OpenShiftConfig implements Config {

    static final OpenShiftConfig instance = new OpenShiftConfig();

    private OpenShiftConfig() {
    }
    @Override
    public String baseUrl() {
        return "https://omni-test.omn-dev01-rnd.apps.okd.dev.gazprombank.ru/omni-oks-cards/";
    }
    public String token() {
    ...
    public String wiremockUrl() {
        return "http://TBD/omni-oks-cards-wiremock/";
    }
}
